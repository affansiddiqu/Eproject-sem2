...
$fetch = "SELECT * FROM `form` where scompany = '$row1' AND city = '$row2' AND status = 'deliver' order by fid desc limit {$offset}, {$limit}";
...
<?php
$fetchpage = "SELECT * from form where scompany = '$row1' AND city = '$row2' AND status = 'deliver'";
