                ...
                <tbody>
                  <?php while ($row = mysqli_fetch_assoc($data)) {
                    ...
                    <tr>
                      ...
                      <td ><a href="del.php?fid=<?php echo $row['fid'];?>" class="btn btn-success">Delivered</a></td>
                  </tr>
                <?php
                    }
                ?>
...
<?php
$fetchpage = "SELECT * from form where scompany = '$row1' AND city = '$row2' AND status = 'in progress'";
