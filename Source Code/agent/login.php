...
if(isset($_POST['login'])){
  $login_company = $_POST['lcompany'];
  $login_city = $_POST['lcity'];
  $login_pass = $_POST['lpassword'];

  $log_query = "select * from `add` where company = '$login_company' AND city = '$login_city'";
...
<div class="container">
        ...
        <div class="form-group">
                <input type="text" class="form-control form-control-user" id="exampleInputEmail"
                    placeholder="Company Name" name="lcompany" required>
            </div>
            <br>
            <div class="form-group row">
                <div class="col-sm-6 mb-3 mb-sm-0">
                    <input type="text" class="form-control form-control-user"
                        id="exampleInputPassword" placeholder="City" name="lcity" required>
                </div>
              </div>
