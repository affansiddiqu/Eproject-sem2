...
$fetch = "SELECT * FROM `form` where status = 'deliver' order by fid desc limit {$offset}, {$limit}";
 ...
 <div class="container">
        ...
        <div class="row justify-content-left">
            ...
            <div class="col-xl-10 col-lg-12 col-md-9">
                <h2>All Deliver Courier Detail</h2>
                <hr>
            <table class="table table-warning">
                ...
                <tbody>
                    ...
                    <!-- <td ><a href="del.php?fid=<?php echo $row['fid'];?>" class="btn btn-success">Progress</a></td> -->
                    <!-- <td ><a href="trash.php" class="btn btn-danger">Deliver</a></td>   -->
                </tr>
                <?php
                    }
                ?>
